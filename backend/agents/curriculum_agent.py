...
3. When the user asks for a semester, use exact equality (=) to match the semester value.
4. Do NOT use CONTAINS, toLower(), regex, or any case-insensitive matching.
5. Retrieve ALL courses that belong to the specified semester.
6. Return all relevant course information requested by the user.
7. Always specify relationship direction clearly.
